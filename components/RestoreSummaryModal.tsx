...
const RestoreSummaryModal: React.FC<RestoreSummaryModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-slate-800 rounded-2xl p-8 w-full max-w-3xl shadow-2xl relative max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-cyan-400 mb-4">Geri Yükleme Özeti</h2>
